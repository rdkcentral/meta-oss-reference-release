...
| Components | Tag |
|----------|--------|
| packagegroup-oss-layer | 4.7.4-r0|
...
The 4.7.4 OSS release, based on the kirkstone yocto version, delivers architecture-specific and platform-independent artifacts. Within this release, ARM architecture is accommodated with the following variations:
...
|207| orc | (0.4.31-r0) |
|208| packagegroup-oss-layer | (4.7.4-r0) |
|209| perl | (5.34.3-r0) |
...
- [ ] meta-rdk-oss-reference [4.7.2-->4.7.3] (https://github.com/rdkcentral/meta-rdk-oss-reference/compare/4.7.2...4.7.3)
